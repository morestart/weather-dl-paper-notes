...
- [Xaurora：谱一致性 S2S 微调](notes/05-xaurora-egu-abstract.md) — EGU 摘要级解读；只有概念流程与披露情况表，不填造性能数字。
- [ESFM S2S 策略：多尾、LoRA 与慢变量注意力](notes/06-esfm-s2s-egu-abstract.md) — EGU 摘要及海报解读，记录 38 天/96 成员实例与缺失的评分细节。
...
- 其余 23 篇的旧版短笔记正在重新核验。它们**尚未达到详细阅读笔记标准**，因此暂不放入仓库主目录。
