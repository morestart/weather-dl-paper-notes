...
本次公开批次为 **54 篇独立笔记**，其中 **53 篇按可取得原文完成逐篇核验**，会议摘要与 Perspective 按来源等级解读，不冒充完整实验论文；另 **1 篇 #19 仅取得期刊摘要、开放前页与出版方图注**，虽已整理并上传，仍需要全文方法和补充材料才能称为完整精读。2024–2026 全年回溯也未穷尽。因此本仓库仍不能称为“全部完成”。[论文追踪表](气象大模型_中期预报论文追踪.md)保留全部 54 条书目与版本历史。
